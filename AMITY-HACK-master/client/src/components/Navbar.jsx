...
function Navbar() {
  return (
    <section>
  <nav class=" py-6 m-10 rounded-2xl bg-white/20 z-50 ">
    <div class="container px-4 mx-auto">
      <div class="flex items-center relative">
        <a class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 inline-block text-4xl font-bold text-white" href="#">
          Nutritionist AI
        </a>
        
        <div class="hidden lg:block ml-auto">
          <div class="flex items-center">
            <a class="inline-block mr-9 text-sm font-semibold text-orange-900 hover:text-orange-50" href="#">Sign In</a>
            <a class="relative group inline-block py-3 px-4 text-sm font-semibold text-orange-50 hover:text-orange-900 bg-orange-900 rounded-md overflow-hidden transition duration-300" href="#">
  ...
  <div class="hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-md z-50">
    ...
    <nav class="relative flex flex-col py-6 px-10 w-full h-full bg-white border-r overflow-y-auto">
      <div class="flex items-center mb-16">
        <a class="mr-auto text-6xl font-medium leading-none" href="#">
          Nutritionist AI
        </a>
        <button class="navbar-close">
          <svg class="h-6 w-6 text-gray-300 cursor-pointer hover:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke="currentColor">
      ...
      <div>
        <ul class="mb-2">
          <li><a class="block py-4 px-5 text-gray-300 hover:bg-orange-50 rounded-lg" href="#">About Us</a></li>
          <li><a class="block py-4 px-5 text-gray-300 hover:bg-orange-50 rounded-lg" href="#">Featured</a></li>
          <li><a class="block py-4 px-5 text-gray-300 hover:bg-orange-50 rounded-lg" href="#">Solutions</a></li>
          <li><a class="block py-4 px-5 text-gray-300 hover:bg-orange-50 rounded-lg" href="#">Products</a></li>
          <li><a class="block py-4 px-5 text-gray-300 hover:bg-orange-50 rounded-lg" href="#">Articles</a></li>
        </ul>
        ...
        <div class="flex px-6 mb-16 items-center"><a class="inline-block mr-9 text-sm font-semibold text-orange-900 hover:text-gray-300" href="#">Sign In</a><a class="inline-block py-3 px-4 text-sm font-semibold text-orange-900 hover:text-white border border-gray-300 hover:border-orange-600 hover:bg-orange-900 rounded-md transition duration-200" href="#">Create an account</a></div>
        <div>
          ...
          <span class="block mb-3 text-sm text-gray-300">Drop us a line</span>
