...
function SignIn() {
  ...
  return (
    <section class="relative py-20 xl:py-10 overflow-hidden">
      ...
      <div class="flex flex-wrap -mx-4 items-center">
        ...
        <div class="w-full lg:w-1/2 px-4">
          <div class="relative max-w-md lg:max-w-2xl mx-auto lg:mr-0">
            <img class="block h-full w-full" src="saturn-assets/images/sign-up/image-funny.png" alt=""/>
            <div class="absolute bottom-0 w-full left-0 p-4 lg:px-12 xl:px-20 sm:pb-16">
              <div class="p-10 backdrop-blur-md backdrop-filter bg-black bg-opacity-30 rounded-5xl">
                ...
                <div class="flex items-start">
                  <img src="saturn-assets/images/sign-up/avatar-pink.png" alt=""/>
                  <div class="ml-4">
