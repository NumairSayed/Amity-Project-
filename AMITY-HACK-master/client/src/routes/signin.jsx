      ...
      <div class="flex flex-wrap -mx-4 items-center">
        <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
          <div class="max-w-md mx-auto lg:mx-0">
            ...
            <div class="mb-6">
                <label class="block mb-1.5 text-sm text-gray-400 font-semibold" for="">Name</label>
                <input class="w-full py-3 px-4 text-sm text-gray-400 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="text" placeholder="Your Name" value={name} onChange={(e)=>setName(e.target.value)}/>
              </div>
              <div class="mb-6">
                <label class="block mb-1.5 text-sm text-gray-400 font-semibold" for="">Email</label>
                <input class="w-full py-3 px-4 text-sm text-gray-400 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="email" placeholder="pat@saturn.dev" value={email} onChange={(e)=>{setEmail(e.target.value)}}/>
              </div>
              <div class="mb-7">
          ...
          <div class="relative max-w-md lg:max-w-2xl mx-auto lg:mr-0">
            ...
            <div class="absolute bottom-0 w-full left-0 p-4 lg:px-12 xl:px-20 sm:pb-16">
              <div class="p-10 backdrop-blur-md backdrop-filter bg-black bg-opacity-30 rounded-5xl">
                <p class="text-white font-medium mb-6">I’m impressed with the result I’ve seen since starting to use this product, I started to see difference in the first week.</p>
